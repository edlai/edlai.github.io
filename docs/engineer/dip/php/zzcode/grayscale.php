...
*/
  ...
  $img_grayscale_1 = $uploaddir . 'lena_grayscale_1.png';
  imagepng($img, $img_grayscale_1);
  imagedestroy($img);
  ...
  echo "<tr>";
  echo "  <td> Original </td>";
  echo "  <td> Grayscale (Formula: (r+g+b)/3 )</td>";
  echo "</tr>";
  echo "<tr>";
  echo '  <td>' . '<img src='. $file .' alt="original">'. '</td>';
  echo '  <td>' . '<img src='. $img_grayscale_1 .' alt="grayscale">'. '</td>';
  echo "</tr>";
  echo "</table>";
